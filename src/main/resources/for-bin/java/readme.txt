...
The file metawidget-all.jar contains all of Metawidget bundled into one JAR for easy deployment. To get started, we strongly recommend the Metawidget tutorial: http://metawidget.org/doc/reference/en/html/ch01.html#section-introduction-java-part1
