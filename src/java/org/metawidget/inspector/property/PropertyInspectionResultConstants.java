...
/**
 * Property-specific element and attribute names appearing in DOMs conforming to
 * inspection-result-1.0.xsd.
 *
 * @author Richard Kennard
 */

public final class PropertyInspectionResultConstants
{
	//
	//
	// Public statics
	...
	private PropertyInspectionResultConstants()
	{
		// Can never be called
	}
}
