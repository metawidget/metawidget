 ...
 * performant and not all environments (eg. J2SE 1.4, Android) support schema validation.
 *
	...
	extends CompositeInspector
{
	...
	public ValidatingCompositeInspector( CompositeInspectorConfig config, ResourceResolver resolver )
	{
