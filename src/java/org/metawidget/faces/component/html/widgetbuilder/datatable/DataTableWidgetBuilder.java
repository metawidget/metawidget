...
public class DataTableWidgetBuilder
	implements WidgetBuilder<UIComponent, UIMetawidget>
{
	...
	public DataTableWidgetBuilder()
	{
		this( new DataTableWidgetBuilderConfig() );
	}

	public DataTableWidgetBuilder( DataTableWidgetBuilderConfig config )
	{
		...
		throws Exception
	{
		...
		if ( TRUE.equals( attributes.get( HIDDEN ) ) || attributes.containsKey( LOOKUP ) || attributes.containsKey( FACES_LOOKUP ))
			return null;
