...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:xslthl="http://xslthl.sf.net" exclude-result-prefixes="xslthl" version='1.0'>
	...
	<xsl:param name="admon.graphics.path">@file.prefix@@dbf.xsl@/../shared/images/</xsl:param>
	<xsl:param name="admon.graphics.extension">.png</xsl:param>
	<xsl:param name="admon.style">
  		<xsl:value-of select="concat('margin-', $direction.align.start, ': 0.2in; margin-', $direction.align.end, ': 0.2in;')"></xsl:value-of>
	</xsl:param>	
	...
	<xsl:template match="filename|classname|function|guibutton">
	...
	<xsl:template name="table.cell.properties">
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:if test="ancestor::tr[count(preceding-sibling::tr) mod 2 = 0]">
	...
	<!-- Placement of titles -->
	<xsl:param name="formal.title.placement">figure after example after equation after table after procedure after</xsl:param>
	...
	<xsl:param name="insert.link.page.number">
		yes
	</xsl:param>
