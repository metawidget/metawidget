...
package org.metawidget.integrationtest.gwt.quirks.client;
...
import org.metawidget.integrationtest.gwt.quirks.client.ui.QuirksModule;
...
public class GwtTestQuirks
	...
	public String getModuleName() {
		...
		return "org.metawidget.integrationtest.gwt.quirks.GwtTestQuirks";
	}
	...
	public void testQuirks()
		...
		assertEquals( "org.metawidget.integrationtest.gwt.quirks.client.model.GwtQuirks", metawidget.getPath() );
					...
					public void run() {
						...
						try {
							...
							for ( Throwable cause : umbrella.getCauses() ) {
								if ( "nestedAction called".equals( cause.getMessage() )) {
									nestedActionCalled = true;
									break;
								}
							}

							assertTrue( nestedActionCalled );
						}
	...
	public void testTabQuirks()
		...
		assertEquals( "org.metawidget.integrationtest.gwt.quirks.client.model.GwtTabQuirks", metawidget.getPath() );
