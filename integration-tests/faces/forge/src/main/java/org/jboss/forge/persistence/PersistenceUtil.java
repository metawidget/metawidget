...
public class PersistenceUtil
	...
	protected <T> void delete( final T entity )
	...
	protected <T> T deleteById( final Class<T> type, final Long id )
		throws NoResultException {
	...
	protected <T> T findById( final Class<T> type, final Long id )
		throws NoResultException {
	...
	protected Class<?> getObjectClass( final Object type )
