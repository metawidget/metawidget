...
public class CssStyleProcessorTest
	...
	public void testSimpleType() {
		...
		String result = "<table id=\"table-orgMetawidgetStaticallyJspHtmlWidgetprocessorCssStyleProcessorTestFoo\">" +
				"<tbody><tr>" +
				"<th><label>Bar</label></th>" +
				"<td><input name=\"fooBar\" style=\"stylin\" styleClass=\"styleClassin\" type=\"text\" value=\"${foo.bar}\"/></td>" +
				"<td/>" +
				"</tr><tr>" +
				"<th><label>Baz</label></th>" +
				"<td><input name=\"fooBaz\" style=\"stylin\" styleClass=\"styleClassin\" type=\"text\" value=\"${foo.baz}\"/></td>" +
				"<td/>" +
				"</tr></tbody>" +
				"</table>";
