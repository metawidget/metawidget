...
public class NameProcessorTest
	...
	public void testSimpleType() {
		...
		String result = "<table id=\"table-orgMetawidgetStaticallyHtmlWidgetprocessorNameProcessorTestFoo\"><tbody><tr><th>" +
				"<label>Bar</label></th><td><input name=\"nameProcessorExampleBar\" type=\"text\"/></td>" +
				"<td/>" +
				"</tr><tr>" +
				"<th><label>Baz</label></th>" +
				"<td><input name=\"nameProcessorExampleBaz\" type=\"text\"/></td>" +
				"<td/></tr></tbody></table>";
