...
import org.metawidget.vaadin.layout.TabSheetLayoutDecorator;
...
public class SimpleBindingProcessorTest
	...
	public void testNestedMetawidget() {
		...
		metawidget.setLayout( new TabSheetLayoutDecorator( new LayoutDecoratorConfig<Component, ComponentContainer, VaadinMetawidget>().setLayout( new org.metawidget.vaadin.layout.FormLayout() ) ) );
