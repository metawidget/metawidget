 ...
 */
public class CollectionBindingProcessor
	implements
	...
	public Component processWidget( Component component, String elementName,
		...
		TableDataSource tableDataSource = new TableDataSource( componentClass,
			...
			@Override
			public boolean addItemToCollection( Comparable item )
	...
	public interface CollectionBindingNotifier {
		...
		void addItemToCollection( Object item )
			throws RuntimeException;

		void removeItemFromCollection( Object item )
			throws RuntimeException;
