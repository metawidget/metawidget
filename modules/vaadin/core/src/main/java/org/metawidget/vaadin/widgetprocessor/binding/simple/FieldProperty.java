...
/* package private */class FieldProperty
	 ...
	 */
	public FieldProperty( Object object, String property )
	...
	/**
	 * Returns the type of the FieldProperty. The methods <code>getValue</code> and
	 ...
	 * the method <code>setValue</code> will throw <code>ReadOnlyException</code>s and will not
	 * modify the value of the
	 * Property.
	 *
	 * @return <code>true</code> if the Property is in read-only mode, <code>false</code> if it's
	 *         not
	 */
	...
	/**
	 * Sets the value of the property. This method supports setting from <code>String</code> if
	 * either <code>String</code> is directly assignable
	 ...
	 *         be converted into the Property's native type directly or through <code>String</code>
	 *         or determined convertor.
	 */
