<?php $useTooltips = true; require_once 'include/page-start.php'; ?>
	...
	<div id="newsticker" style="display: none">
		<ul>
			...
			<li>
				...
				<a href="http://java.dzone.com/news/%E2%80%9Cperfect-web-framework%E2%80%9D-there" target="_blank">Steven Goldsmith (Java Developer)</a>
			</li>
			<li>
				I'd like to thank you for what you've done with Metawidget. It's a really great framework and is proving<br/>
	...
	<?php $useQuickStart = true; require_once 'include/body-start.php'; ?>
		...
		<center>
			<div style="width: 750px">
				<img src="media/overview.png" usemap="#overiew-map" style="border: 0; padding-top: 5px; margin-bottom: 20px; display: block; height: 500px" alt=""/>
			...
			<table id="supported-tech">
				...
				<tbody>
					<tr>
						...
						<td>
							<h3>2. Back-Ends</h3>
							<em>Metawidget can read domain object<br/>information from all of these</em>
							<ul>
								<li>Annotations</li>
