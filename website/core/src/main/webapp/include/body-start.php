		...
		<tr>			
			<td id="left-bar">
				...
				<div class="badges" style="height: 593px; padding-top: 5px; border: 1px solid #dddddd; background-color: #eeeeee">
					...
					<a href="http://jboss.org/forge" target="_blank" style="top: 130px; left: 95px">
						<img src="/media/logos/logo-forge.gif" alt="JBoss Forge" style="border: 0px" />
					</a>
					<a href="http://code.google.com/webtoolkit" target="_blank" style="top: 172px; left: 25px">
						<img src="/media/logos/logo-gwt.gif" alt="Google Web Toolkit" style="border: 0px" />
					</a>
					<a href="http://groovy.codehaus.org" target="_blank" style="top: 172px; left: 90px">
						<img src="/media/logos/logo-groovy.gif" alt="Groovy" style="border: 0px" />
					</a>
					<a href="http://hibernate.org" target="_blank" style="top: 236px; left: 68px">
						<img src="/media/logos/logo-hibernate.gif" alt="Hibernate" style="border: 0px" />
					</a>
					<a href="http://icefaces.org" target="_blank" style="top: 275px; left: 2px">
					...
					<a href="http://oval.sourceforge.net" target="_blank" style="top: 360px; left: 3px">
						<img src="/media/logos/logo-oval.gif" alt="OVal" style="border: 0px" />
					</a>
					<a href="http://primefaces.org" target="_blank" style="top: 313px; left: 46px">
						<img src="/media/logos/logo-primefaces.gif" alt="PrimeFaces" style="border: 0px" />
					</a>
					<a href="http://jboss.org/jbossrichfaces" target="_blank" style="top: 387px; left: 70px">
						<img src="/media/logos/logo-richfaces.gif" alt="RichFaces" style="border: 0px" />
					</a>
					<a href="http://www.scala-lang.org" target="_blank" style="top: 434px; left: 10px">
						<img src="/media/logos/logo-scala.gif" alt="Scala" style="border: 0px" />
					</a>
					<a href="http://springframework.org" target="_blank" style="top: 427px; left: 110px">
					...
					<a href="http://myfaces.apache.org/tomahawk" target="_blank" style="top: 522px; left: 15px">
						<img src="/media/logos/logo-tomahawk.gif" alt="Tomahawk" style="border: 0px" />
					</a>
					<a href="http://vaadin.org" target="_blank" style="top: 563px; left: 45px">
