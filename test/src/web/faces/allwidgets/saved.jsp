...
<f:view>
	...
	<html>
		<body>
			...
			<m:metawidget id="allWidgetsMetawidget" value="#{allWidgets}" createHiddenFields="true" rendererType="div" readOnly="true" inspectorConfig="config/inspector-config.xml">
