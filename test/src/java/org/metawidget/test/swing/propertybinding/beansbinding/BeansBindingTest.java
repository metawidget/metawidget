...
package org.metawidget.test.swing.propertybinding.beansbinding;
	...
	extends TestCase
{
		...
		throws Exception
	{
		...
		{
			assertTrue( "When binding org.metawidget.test.swing.propertybinding.beansbinding.BeansBindingTest$CantLoadSaveFoo/bar to class javax.swing.JTextField.text (have you used BeansBinding.registerConverter?)".equals( e.getMessage() ) );
		}
	}
