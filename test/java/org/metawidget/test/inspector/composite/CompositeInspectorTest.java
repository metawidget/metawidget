	...
	extends TestCase
{
	...
	public void testInspection()
	{
		...
		xml += "<inspection-result xmlns=\"http://metawidget.org/inspection-result\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://metawidget.org/inspection-result http://metawidget.org/inspection-result-1.0.xsd\">";
		...
		config.setInspectors( inspectorXml, new JavaBeanInspector() );
	...
	public void testDefensiveCopy()
		throws Exception
	{
		JavaBeanInspector inspector = new JavaBeanInspector();
