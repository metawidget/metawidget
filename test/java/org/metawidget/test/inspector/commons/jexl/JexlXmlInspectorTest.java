	...
	extends TestCase
{
	...
	public void testXml()
	{
		...
		xml += "<entity type=\"org.metawidget.test.inspector.commons.jexl.JexlXmlInspectorTest$Foo\">";
		...
		assertTrue( "org.metawidget.test.inspector.commons.jexl.JexlXmlInspectorTest$Foo".equals( entity.getAttribute( TYPE ) ) );
