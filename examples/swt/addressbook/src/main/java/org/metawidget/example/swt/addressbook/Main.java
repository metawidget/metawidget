...
public class Main {
	...
	public Main( Shell shell ) {
		...
		mBackgroundImage = new Image( mShell.getDisplay(), ClassLoader.getSystemResourceAsStream( "media/background.jpg" ) );
		...
		mLeftImage = new Image( mShell.getDisplay(), ClassLoader.getSystemResourceAsStream( "media/addressbook.gif" ) );
	...
	private void createResultsSection() {
		...
		mPersonalContactImage = new Image( mShell.getDisplay(), ClassLoader.getSystemResourceAsStream( "media/personal-small.gif" ) );
		mBusinessContactImage = new Image( mShell.getDisplay(), ClassLoader.getSystemResourceAsStream( "media/business-small.gif" ) );
